...
#define STEEMIT_STOP_BLOCK_AT_NUM               (10U)

#else // IS LIVE STEEM NETWORK

#define STEEMIT_STOP_BLOCK_AT_TIME              (fc::time_point_sec(fc::time_point::now()) + 10)
#define STEEMIT_STOP_BLOCK_AT_NUM               (20034000U)
...
#define STEEMIT_RECENT_RSHARES_DECAY_RATE_HF19  (fc::days(30))
...
#define STEEMIT_INIT_SUPPLY                     int64_t(1000000000000ll) // 1b
