...
void database::init_genesis( uint64_t init_supply )
{
   try
   {
      ...
      create< witness_schedule_object >( [&]( witness_schedule_object& wso )
      {
         ...
         wso.max_voted_witnesses = STEEMIT_MAX_VOTED_WITNESSES;
         wso.max_miner_witnesses = STEEMIT_MAX_MINER_WITNESSES;
         wso.max_runner_witnesses = STEEMIT_MAX_RUNNER_WITNESSES;
      } );
...
{ try {
   ...
   if( next_block.timestamp >= STEEMIT_STOP_BLOCK_AT_TIME )
   {
